...
var (
	...
	// oidFriendlyName
	_             = asn1.ObjectIdentifier([]int{1, 2, 840, 113549, 1, 9, 20})
	oidLocalKeyID = asn1.ObjectIdentifier([]int{1, 2, 840, 113549, 1, 9, 21})
	// oidMicrosoftCSPName
	_ = asn1.ObjectIdentifier([]int{1, 3, 6, 1, 4, 1, 311, 17, 1})

	// oidJavaTrustStore
	_ = asn1.ObjectIdentifier([]int{2, 16, 840, 1, 113894, 746875, 1, 1})
	// oidAnyExtendedKeyUsage
	_ = asn1.ObjectIdentifier([]int{2, 5, 29, 37, 0})
)
